...
const getWeather=async(city)=>
{
    try{
        ...
        if(id<300 && id>200)
            {
                tempimage.src="./image/thunderstorm.jpg"
            }

           else  if(id<400 && id>300)
            {
                tempimage.src="./image/ cloud-solid.jpg"
            }
             else if(id<600 && id>500)
            {
                tempimage.src="./image/rain.jpg"
            }
           else  if(id<700 && id>600)
            {
               tempimage.src="./image/snow1.png"
            }
            ...
            {
                tempimage.src="./image/cloud and sun.png"
            }
